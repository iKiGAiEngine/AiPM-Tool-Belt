...
export function registerProjectRoutes(app: Express) {
  ...
  app.patch("/api/proposal-log/entry/:id", async (req: Request, res: Response) => {
    try {
      ...
      const allowedFields = ["nbsEstimator", "estimateStatus", "proposalTotal", "gcEstimateLead", "anticipatedStart", "anticipatedFinish", "dueDate", "notes", "bcLink", "nbsSelectedScopes", "finalReviewer", "swinertonProject", "region", "primaryMarket", "inviteDate", "filePath"];
